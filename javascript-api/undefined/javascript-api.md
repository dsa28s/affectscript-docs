...
배열을 기본적으로 **오름차순** 으로 정렬합니다. 매개변수로 들어올 수 있는 형식의 경우의 수는 **2가지** 입니다.
...
`index` 번째의 글자 **하나** 를 반환합니다. `index` _는 0부터 시작합니다._
...
해당 날짜 객체에서 '연도' 를 설정합니다. 추가 매개변수가 있을 경우 '월', '일' 도 설정할 수 있습니다.
